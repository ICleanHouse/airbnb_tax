...
ClickUp is connected to Codex and Cowork via MCP (`https://mcp.clickup.com/mcp`). See `CLICKUP_CLAUDE_SETUP.md` in the repo root for full setup instructions.
...
| Tag | Meaning |
|---|---|
| `Codex-ready` | Fully spec'd, safe to implement autonomously |
...
### What Codex should NOT do autonomously on ClickUp tasks
