...
| D03-15 | Agency recovery boundary | Agency/member, host, operator | Open-live agency recovery; delegated member submits an append-only release request and the agency acts through explicit lifecycle services | Partial parity can overwrite member history or expose the wrong participant | Preserve immutable source delegation and host-only successor authorization | Repository owner | Superseded by ADR-0003; temporary `agency_live_recovery_disabled` 409 is permitted only while the rollout flag is false | 2026-07-29 |
...
|---|---|---|---|---|---|---|
| D03-21 | Operational-success evidence and schedule tolerance | Host affirmation or approved auditable evidence within +/-30 minutes; unknown remains in denominator, not numerator | Record evidence and tolerance | Repository owner | Approved S1-D05 decision | 2026-07-29 |
| D03-22 | Activation window | 14 days | Fixed pilot activation window | Repository owner | Approved S1-D05 decision | 2026-07-29 |
| D03-23 | Match-mode precedence and organic threshold | Any prior targeted host/operator outreach is non-organic; organic liquidity has no numeric gate | Prevent outreach misclassification | Repository owner | Approved S1-D05 decision | 2026-07-29 |
| D03-24 | Operator-time formula | Successful-turnover minutes only; descriptive total, median, and maximum; no threshold | Keep support burden distinct | Repository owner | Approved S1-D05 decision | 2026-07-29 |
| D03-25 | Host cancellation after supply exposure | Exclude from standard-turnover denominator; report count/reason separately | Keep standard-success measures interpretable | Repository owner | Approved S1-D05 decision | 2026-07-29 |
